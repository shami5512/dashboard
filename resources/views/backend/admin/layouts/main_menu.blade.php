<div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
    <div class="navbar-header">
        <ul class="nav navbar-nav flex-row">
            <li class="nav-item mr-auto"><a class="navbar-brand" href="/">
                    ...
                    <h2 class="brand-text mb-0">New PNP</h2>
                </a></li>
    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation" data-icon-style="lines">
            ...
            {{-- <li class="nav-item {{ (request()->routeIs('user.index')) ? 'active' : '' }}"><a href="{{ route('user.index') }}"><i class="menu-livicon"
                data-icon="users"></i><span class="menu-title text-truncate"
                data-i18n="Accounts">Accounts</span></a>
            </li> --}}
            <li class="nav-item {{ (request()->routeIs('admin.device.index')) ? 'active' : '' }}"><a href="{{ route('admin.device.index') }}"><i class="menu-livicon"
                data-icon="search"></i><span class="menu-title text-truncate"
                data-i18n="Device">Position Device</span></a>
            </li>
