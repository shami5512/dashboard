<div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
    <div class="navbar-header">
        <ul class="nav navbar-nav flex-row">
            <li class="nav-item mr-auto"><a class="navbar-brand"
                    ...
                    <h2 class="brand-text mb-0">User-PNP</h2>
                </a></li>
    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation"
            ...
            <li class="nav-item {{ request()->routeIs('user.device.index') ? 'active' : '' }}"><a
                    href="{{ route('user.device.index') }}"><i class="menu-livicon" data-icon="search"></i><span
                        class="menu-title text-truncate" data-i18n="Device">Position Device</span></a>
            </li>
        </ul>
    </div>
</div>
